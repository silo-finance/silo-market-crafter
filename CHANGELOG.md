...
## 0.37.1 - 2026-06-01
### Fixed
- lock a single deployment payload after simulation and reuse the exact same arguments for estimateGas and transaction execution.
...
## 0.36.0 - 2026-05-11
### Added
- add market-to-market compare mode on verification
...
## 0.33.1 - 2026-04-27
### Fixed
- adjust some ui style

## 0.33.0 - 2026-04-27
### Added
- prompt wallet to add missing selected chain

### Fixed
- fix token swap in step 1 to keep metadata and resolved addresses in sync

## 0.32.0 - 2026-04-27
### Added
- add support for Mantle and MegaETH networks
...
## 0.23.0 - 2026-03-25
### Added
- add chain argument to verification page, so we can switch blockchain automatically
