    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10 overflow-hidden">
          <div className="absolute -top-40 -right-32 w-80 h-80 bg-blue-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
          <div className="absolute -bottom-40 -left-32 w-80 h-80 bg-purple-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Silo Market Crafter?
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Built on proven blockchain technology with lightning-fast transactions</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Join a growing community of DeFi innovators and traders</p>
            </div>
          </div>
        </div>
      </section>
