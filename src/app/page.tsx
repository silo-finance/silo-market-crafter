        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-300">Built on proven blockchain technology with lightning-fast transactions</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-300">Intuitive interface designed for both beginners and experts</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-300">Join a growing community of DeFi innovators and traders</p>
            </div>
          </div>
        </div>
      </section>
